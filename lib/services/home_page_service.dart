...
class HomePageServices {
  ...
  Future<HomeModel> getWeatherData({required String cityName}) async{
    HomeModel? model;
    //Get the weather data from the API
    Response  response = await dio.get("http://api.weatherapi.com/v1/forecast.json?key=$apiKey&q=$cityName&days=7");
